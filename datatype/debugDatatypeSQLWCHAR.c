...
int SQLBindParameter_SQL_C_UBIGINT_to_SQL_WCHAR(t_ODBCHDLInfo *pTestInfo)
{
	...
	char dropStr[] = "DROP TABLE IF EXISTS TB_WCHAR";
	char createStr[] = "CREATE TABLE TB_WCHAR (C WCHAR(200))";
	char insertStr[] = "INSERT INTO TB_WCHAR VALUES (?)";
	char selectStr[] = "SELECT C FROM TB_WCHAR";
	LogMsg(NONE, "\nstart  test %s..............\n", __FUNCTION__);
...
int SQLBindParameter_SQL_C_NUMERIC_to_SQL_WCHAR(t_ODBCHDLInfo *pTestInfo)
{
	SQLLEN StrLen_or_IndPtr;
	RETCODE retcode;
	SQLHANDLE 	henv;
...
int SQLBindParameter_SQL_C_BINARY_to_SQL_WCHAR(t_ODBCHDLInfo *pTestInfo)
{
	SQLLEN StrLen_or_IndPtr;
	RETCODE retcode;
	SQLHANDLE 	henv;
...
//#ifdef __TRAFODION__ 
	...
	/*****************test********************/
	SQLBindParameter_SQL_C_UBIGINT_to_SQL_WCHAR(&mODBCHDLInfo);
	SQLFreeStmt(mODBCHDLInfo.hstmt, SQL_CLOSE);
	SQLBindParameter_SQL_C_NUMERIC_to_SQL_WCHAR(&mODBCHDLInfo);
	SQLFreeStmt(mODBCHDLInfo.hstmt, SQL_CLOSE);
	SQLBindParameter_SQL_C_BINARY_to_SQL_WCHAR(&mODBCHDLInfo);
	/***************************************/
