...
/*******************************************************************************************************************/
int debugNumeric(TestInfo *pTestInfo)
{
    int ret = 0;
    RETCODE retcode;
    ...
    TCHAR *szDdl = _T("create table tb(")
                    ...
                    _T("C4 NUMERIC(19,5)")
                    _T(")");
 #define CONFIG_COLUMNS_VALUES      4                   
    struct
	{
	...
	{	
		{18,19,20,19},
		{0, 0, 0, 5},
		{12345678.0, 12345678.0, 12345678.0, 12345678.123},
		{12345678.0, 12345678.0, 12345678.0, 12345678.123},
        {_T("12345678"), _T("12345678"), _T("12345678"), _T("12345678.123")}      
