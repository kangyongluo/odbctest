 ...
 int main (int argc, char *argv[])
{
  ...
  if (!SQL_SUCCEEDED(returnCode))
    ...
    returnCode = SQLBindParameter(hstmt, 2, SQL_PARAM_INPUT, SQL_C_TYPE_TIMESTAMP, SQL_TIMESTAMP, 
    ...
    returnCode = SQLBindParameter(hstmt, 4, SQL_PARAM_INPUT, SQL_C_TYPE_TIMESTAMP, SQL_TIMESTAMP, 
