...
/*******************************************************************************************************************/
int M_SQLSetConnectOption_SQL_MAX_LENGTH(TestInfo *pTestInfo)
{
    SQLLEN len;
    RETCODE retcode;
...
#if 1
    retcode = SQLSetConnectOption((SQLHANDLE)hdbc, SQL_MAX_LENGTH, 10);
...
int main(int argc, char *argv[])
{
    ...
    M_SQLSetConnectOption_SQL_MAX_LENGTH(&oriInfo);
#ifndef unixcli
    printf("Please enter any key exit\n");
    getchar();
#endif
